...
const description ="Onchain Gifts";
  ...
  const getAbsoluteUrl = "https://GiftonFarcastergnosis.vercel.app/tx-frame-og-image.png";
const BaseFramePage = () => {
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta name="fc:frame:image" content="https://github.com/aarav1656/GiftonFarcastergnosis/blob/main/public/warpcast.png" />
        ...
        <meta
          ...
          content="https://GiftonFarcastergnosis.vercel.app/api/frame/base/get-tx-frame"
        />
      </Head>
      <body>
      ...
      <Flex h={"75vh"} px={20} borderRadius={20} >
        <Flex flexDirection={"row"}>
          <Flex flexDirection={"column"} justifyContent={"center"} w={"60%"}>
            <Stack spacing={4}>
              <Heading fontSize={"xl"}>GiftonFarcastergnosis</Heading>
